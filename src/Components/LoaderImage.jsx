...
const CatalogM = (props) => (
  ...
  >
    ...
    {/* 2 */}
    <rect x="312" y="50" rx="8" ry="8" width="250" height="165" />
    <rect x="312" y="230" rx="5" ry="5" width="200" height="18" />
    <rect x="312" y="270" rx="5" ry="5" width="120" height="15" />
    <rect x="312" y="310" rx="5" ry="5" width="190" height="10" />
    <rect x="312" y="330" rx="5" ry="5" width="190" height="10" />
  </ContentLoader>
);
...
export { MyLoader, CatalogS, CatalogM, CatalogL, CatalogXl };
